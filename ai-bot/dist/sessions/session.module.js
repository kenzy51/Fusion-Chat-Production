...
exports.SessionsModule = SessionsModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: session_schema_1.ChatSession.name, schema: session_schema_1.ChatSessionSchema }]),
        ...
        exports: [session_service_1.SessionsService, mongoose_1.MongooseModule],
    })
], SessionsModule);
