...
<script src="${PRODUCTION_FRONTEND_URL}/embed.js" async></script>`;
              ...
              <div className="space-y-4 pt-2">
                <div>
                  <label className="text-[10px] uppercase font-bold tracking-wider text-zinc-400 block mb-2">
                    Primary Accent Color (Launcher & Buttons)
                  </label>
                ...
                <div className="pt-2">
                  <label className="text-[10px] uppercase font-bold tracking-wider text-zinc-400 block mb-2">
                    Widget Window Base Layer Backing
                  </label>
                  <div className="flex gap-3">
                    <input
                      type="color"
