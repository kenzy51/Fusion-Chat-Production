...
export default function ChatsPage() {
  ...
  // 📊 1. Pull historical sessions for this tenant on load
  useEffect(() => {
  ...
  // 📡 2. Spin up the real-time WebSocket stream connection
  useEffect(() => {
    const ws = new WebSocket("ws://localhost:3003/chat-stream");
    socketRef.current = ws;

    // Look inside your frontend WebSocket useEffect hook block:
    ws.onmessage = (event) => {
